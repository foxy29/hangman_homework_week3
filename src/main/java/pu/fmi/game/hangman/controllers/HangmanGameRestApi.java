...
public class HangmanGameRestApi {
  ...
  //Добавяне на REST endpoint към API за връщан на списък с всички съществуващи игри
  @GetMapping
  public List<HangmanGame> getAllGames(){ return hangmanGameService.getAllGames(); }
